...
import { runRehearsalMatrix, RehearsalResult } from "../src/runner/rehearsal-runner.js";
import { StepTrace } from "../src/types/trace.js";

export async function testRehearsalMatrix(): Promise<boolean> {
  ...
  try {
    ...
    const result: RehearsalResult = await runRehearsalMatrix(sampleTrace, 3, {
      headless: true,
      urlMap
    });
